...
When the analyzer emits an adaptive `presentation_profile`, read its verified `signals` together
with [presentation-recipes.md](presentation-recipes.md). Choose the useful asset for the actual
